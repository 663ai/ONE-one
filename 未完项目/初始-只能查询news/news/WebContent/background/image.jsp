	...
	<body>
		...
		<div class="view-body">
			...
			<div class="manage-head">
				...
				<div>
				<a style="margin-right:75%" href="images_findbyid">添加图片</a>	
				</div>
						<div class="list-content show">
							<div class="offcial-table tr-border margin-big-top clearfix">
								...
								<c:forEach items="${images}" varStatus="i" var="item">
									<div class="tr clearfix border-bottom-none">
										...
										<div class="th w20">
												<a href="images_findbyid?imid=${item.imid}">修改</a>
										    	<a href="images_delete?imid=${item.imid}"  style="color: #FF3366" onclick= 'return confirm( "确定要删除吗? ") '>删除</a>
										</div>
							...
							<div class="page">
								<div class="page">
									<ul class="offcial-page margin-top margin-big-right">
										...
										<a class="next disable" href="images_findall?page=${1 }">首页</a>
										<c:choose>
											<c:when test="${page<=1}">
							    				<li>上一页</li>
							    			</c:when>
							    			<c:otherwise>
							    				<li><a class="next disable" href="images_findall?page=${page-1 }">上一页</a></li>
							    			</c:otherwise>
										</c:choose>
										...
										<c:choose>
							    			...
							    			<c:otherwise>
							    				<li><a class="next disable" href="images_findall?page=${page+1 }">下一页</a></li>
							    			</c:otherwise>
										</c:choose>
										<a class="next disable" href="images_findall?page=${maxpage}">末页</a>
