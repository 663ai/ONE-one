...
<html>
	...
	<body>
		...
		<div class="view-body">
			...
			<div class="view-product background-color">
				...
				<form id="form1" name="form1" method="post" action="">
					<a style="margin-right:65%" href="manager_findid!findid.action">添加用户</a>
				 </form>
				</div>
								...
								<div class="tr-th clearfix">
								 ...
								 <c:forEach items="${managers}" varStatus="i" var="item">
									<div class="tr clearfix border-bottom-none">
										...
										<div class="th w20">
												<a href="manager_findid!findid.action?managerid=${item.managerid}">修改</a>
										    	<a href="manager_delete!delete.action?managerid=${item.managerid}"  style=" margin-left:5px;color: #FF3366;" onclick= 'return confirm( "确定要删除吗? ") '>删除</a>
										</div>
							...
							<div class="page">
								<div class="page">
									<ul class="offcial-page margin-top margin-big-right">
										...
										<a class="next disable" href="manager_findall?page=${1 }">首页</a>
										<c:choose>
											<c:when test="${page<=1}">
							    				<li>上一页</li>
							    			</c:when>
							    			<c:otherwise>
							    				<li><a class="next disable" href="manager_findall?page=${page-1 }">上一页</a></li>
							    			</c:otherwise>
										</c:choose>
										...
										<c:choose>
							    			...
							    			<c:otherwise>
							    				<li><a class="next disable" href="manager_findall?page=${page+1 }">下一页</a></li>
							    			</c:otherwise>
										</c:choose>
										<a class="next disable" href="manager_findall?page=${maxpage}">末页</a>
		...
		<script type="text/javascript">
			function change(){
				var managername=document.getElementById('managername').values;
				window.location.href="ManagerServlet?type=findpagemore&managername="managername;
			}
		</script>
	</body>
