	...
	<base href="<%=basePath%>">
		...
		<style type="text/css">
			...
			#login{
				...
				width:452px;
				height:452px;
				background-image:url(Images/login_certent.png);
			}
			.main{
			padding-top:270px;
			border:0;
	...
	<body>
		...
		<div id="wrapper">
			    ...
			    <div id="title">
				    ...
				    <div id="login">
				        <form action="background/login.action" method="POST">
								<div class="main">
									<div class="m1">
			                               
											<input name="managername" placeholder="用户名"  type="text" class="ur" autocomplete="off"/>
											<input name="passwd" placeholder="密码" type="password" class="pw" autocomplete="off"/>
		...
		<canva id="canvas" width="1950px" height="800px"></canvas>
    	<canva id="canvasbg" width="1950px" height="800px"></canvas>
