	...
	<body>
		...
		<div class="view-body">
			...
			<div class="view-product background-color">
				...
				<form id="form1" name="form1" method="post" action="catalog_edit" style="text-align:center; margin-top:30px;">		  
				 <p> ｃａｎａｍｅ　　：  
				  <label>
				  <input style="border:1px solid #000000; width:150px; height: 36px; border-radius:5px; background:#D8FCFC;"  name="catalog.caname" type="text" value="${sessionScope.caname }"/>
				  </label>
				  </p>
				  </br>
				  <p>ｃａｎｕｍｂｅｒ：
				    <label>
				    <input style="border:1px solid #000000; width:150px; height: 36px; border-radius:5px; background:#D8FCFC;"  name="catalog.canumber" type=text value="${sessionScope.canumber }"/></label>
				  </p>
				  </br>
				  <p>ｃａｓｔａｔｅ　：  
				    <label>
				   	<select name="catalog.castate" onchange="change()" id="castate">
					   	<c:choose>
					   		<c:when test="${sessionScope.castate eq 1}">
				  ...
				  <p>
				    ...
				    <input type="hidden" name="catalog.caid" value="${sessionScope.caid}" />
				    </label>
				  </p>
				</form>
				</div>
