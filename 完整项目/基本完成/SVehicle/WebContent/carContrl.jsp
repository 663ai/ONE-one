...
<header class="header left">
	...
	<a href="carContrl.jsp">
    <div class="header_center left">
        <h2><strong>监控管理</strong></h2>
        <p class="color_font"><small>Imperfect monitoring interface and imperfect broadcasting system</small></p>
    </div>
	</a>
    <div class="right nav text_right">
        <ul> <li><i class="nav_7"></i><a href="static.action">车辆管理</a> </li>
